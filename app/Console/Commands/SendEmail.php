...
class SendEmail extends Command
{
     ...
     * @var string
     */
    protected $signature = 'notif:email';
     ...
     * @var string
     */
    protected $description = 'Send Email when one of the items that the app supervise in critical state';
    ...
    public function handle()
    {
        ...
        Mail::to('vatoch1720@gmail.com')->send(new Notif($boxs));
        return new Notif($boxs);
        ...
        //         // Mail::to('vatoch1720@gmail.com')->send(new Notif($boxs_notified));
