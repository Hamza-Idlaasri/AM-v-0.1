...
<div class="container p-3">
    ...
    <form action="{{ route('editEG', $equipgroup->servicegroup_id) }}" method="get">
        ...
        <input type="text" name="equipgroup_name" class="form-control w-50 @error('equipgroup_name') border-danger @enderror" id="eg_name" value="{{ $equipgroup->equipgroup_name }}" pattern="[a-zA-Z][a-zA-Z0-9-_+ ]{2,20}" title="EquipGroup name must be between 2 & 20 charcarters in length and containes only letters, numbers, and these symbols -_+">
