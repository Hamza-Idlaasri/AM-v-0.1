...
<div class="container p-3">
    ...
    <form action="{{ route('editHG', $hostgroup->hostgroup_id) }}" method="get">
        ...
        <input type="text" name="hostgroup_name" class="form-control w-50 @error('hostgroup_name') border-danger @enderror" id="hg_name" value="{{ $hostgroup->hostgroup_name }}" pattern="[a-zA-Z][a-zA-Z0-9-_+ ]{2,20}" title="Hostgroup name must be between 2 & 20 charcarters in length and containes only letters, numbers, and these symbols -_+">
