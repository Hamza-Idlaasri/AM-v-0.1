...
<div class="container p-3">
    ...
    <form action="{{ route('editSG', $servicegroup->servicegroup_id) }}" method="get">
        ...
        <input type="text" name="servicegroup_name" class="form-control w-50 @error('servicegroup_name') border-danger @enderror" id="hg_name" value="{{ $servicegroup->servicegroup_name }}" pattern="[a-zA-Z][a-zA-Z0-9-_+ ]{2,20}" title="ServiceGroup name must be between 2 & 20 charcarters in length and containes only letters, numbers, and these symbols -_+">
